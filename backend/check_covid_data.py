...
final_columns = [
    "Date","Admin2","Country_Region","Confirmed","Deaths","Recovered","Active"]

# List to hold individual DataFrames
dfs = []

# Loop through all CSV files in the directory
for f in sorted(glob.glob("csse_covid_19_daily_reports/*.csv")):
...
# Save the final CSV
df_final.to_csv("fusion2_mars2020_mars2022.csv", index=False)

print("Fusion done ! Final CSV created : fusion2_mars2020_mars2022.csv")

end_time = time.time()
print(f"Code executed in: {end_time - start_time:.2f} seconds")
